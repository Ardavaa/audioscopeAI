/**
 * Audioscope AI Flask API Integration
 * 
...
if (typeof document !== 'undefined') {
    document.addEventListener('DOMContentLoaded', () => {
        initializeAPI().then(success => {
            if (success) {
                console.log('✅ Audioscope AI API ready');
                // Dispatch custom event to notify main script
                document.dispatchEvent(new CustomEvent('audioscopeai-api-ready', {
                    detail: { apiStatus }
                }));
            } else {
                console.warn('⚠️ Audioscope AI API initialization failed');
                document.dispatchEvent(new CustomEvent('audioscopeai-api-error', {
